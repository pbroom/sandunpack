...
function buildIndexCode(label: string, accent: string): string {
	const strictModeImport = STRICT_MODE_ENABLED ? ', StrictMode' : '';
  ...
  <StrictMode>
	...
	return `import React, { useEffect${strictModeImport} } from "react";
...
export default function App() {
	...
	const [editorCode, setEditorCode] = useState(
		buildIndexCode(BLANK_LABEL, '#94a3b8'),
	);
			...
			<div className='page'>
				<div className='header'>
					<div>
						...
						<p>
							Uses `loadSandpackClient()` and `updateSandbox()` directly after
				...
				<section className='controls'>
					...
					<div className='actions'>
						...
						<button
							type='button'
							onClick={() => setClientNonce((value) => value + 1)}
						>
							Recreate client
						</button>
						<button
				...
				<div className='layout'>
					<section className='editor-panel'>
						...
						<div className='preview-host' style={{marginTop: 16}}>
							<iframe
								ref={iframeRef}
								title='minimal startup race client preview'
							/>
						</div>
					</section>

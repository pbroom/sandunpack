...
- That non-hosted lifecycle fix is now proposed upstream as `codesandbox/sandpack#1297`, intentionally separated from the hosted-package issue `codesandbox/sandpack#1296` so the preview remount bug can be reviewed on its own merits.
